package com.ssafy.mylio.global.config.swagger;
...
import com.ssafy.mylio.global.aop.swagger.ExampleHolder;
...
//        devServer.setUrl("https://mylio.shop");
//        devServer.setDescription("개발용 서버입니다.");
        ...
        return new OpenAPI()
                ...
                .servers(List.of(prodServer, localServer));//.servers(List.of(devServer, prodServer, localServer));
    }
    ...
    private Info apiInfo() {
        return new Info()
                .title("Malio")
                .description("Api 문서입니다. \n\n **Query Parameter** : Camel Case (ex. `accountId`, `menuId`) \n\n **Request Body** : Camel Case (ex. `accountId`, `menuId`) \n\n **Response Body** : Snake Case (ex. `account_id`, `menu_id`)")
                .version("1.0.0");
    }
}
